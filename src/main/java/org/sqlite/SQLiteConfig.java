...
public class SQLiteConfig
{
    ...
    public void apply( Connection conn ) throws SQLException {
        ...
        skip.add( Pragma.OPEN_MODE.pragmaName );
        skip.add( Pragma.SHARED_CACHE.pragmaName );
        skip.add( Pragma.LOAD_EXTENSION.pragmaName );
        skip.add( Pragma.DATE_PRECISION.pragmaName );
    ...
    public static enum Pragma {
        ...
        LOAD_EXTENSION("enable_load_extension", "Enable SQLite load_extension() function, native driver only", OnOff),
