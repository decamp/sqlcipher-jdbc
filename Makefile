...
$(SQLITE_AMAL_DIR)/sqlite3.c:
	cd $(SQLITE_AMAL_DIR); ./configure;
	make -C $(SQLITE_AMAL_DIR) sqlite3.c
	#$(shell cd $(SQLITE_AMAL_DIR) && ./configure)
...
native: $(SQLITE_AMAL_DIR)/sqlite3.c $(NATIVE_DLL)
